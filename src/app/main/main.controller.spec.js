(function() {
  ...
  describe('controllers', function(){
    ...
    it('should define more than 5 blog articles', function() {
      expect(angular.isArray(vm.blogArticles)).toBeTruthy();
      expect(vm.blogArticles.length === 5).toBeTruthy();
    });
  });
})();
